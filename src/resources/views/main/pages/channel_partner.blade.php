                ...
                <div class="col-md-12">
                    <form method="post" class="contact__form" id="contactForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                <input class="line-gray" name="telephone" id="telephone" type="text" placeholder="Telephone *" required="">
                            </div>
                            <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-3 form-group">
                                <input class="line-gray" name="designation" id="designation" type="text" placeholder="Designation *" required="">
                            </div>
                            <div class="col-md-3 form-group">
                                <input class="line-gray" name="pan" id="pan" type="text" placeholder="PAN No. *" required="">
                            </div>
                            <div class="col-md-3 form-group">
                                <input class="line-gray" name="gst" id="gst" type="text" placeholder="GSTIN *" required="">
                            </div>
                            <div class="col-md-3 form-group">
                                <input class="line-gray" name="sac" id="sac" type="text" placeholder="SAC / HSN Code *" required="">
                            </div>
                            <div class="col-md-3 form-group">
                                <input class="line-gray" name="tax" id="tax" type="text" placeholder="Tax Applicable *" required="">
                            </div>
                            <div class="col-md-3 form-group">
                                <input class="line-gray" name="bank_name" id="bank_name" type="text" placeholder="Bank Name *" required="">
                            </div>
                            <div class="col-md-3 form-group">
                                <input class="line-gray" name="bank_address" id="bank_address" type="text" placeholder="Bank Address *" required="">
                            </div>
                            <div class="col-md-4 form-group">
                                <input class="line-gray" name="bank_branch" id="bank_branch" type="text" placeholder="Branch *" required="">
                            </div>
                            <div class="col-md-4 form-group">
                                <input class="line-gray" name="bank_account_number" id="bank_account_number" type="text" placeholder="Bank Account Number *" required="">
                            </div>
                            <div class="col-md-4 form-group">
                                <input class="line-gray" name="ifsc" id="ifsc" type="text" placeholder="IFSC Code *" required="">
                            </div>
                            <div class="col-4 my-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <input type="radio" id="msme_yes" name="msme" value="1" class="line-gray">
                                        <label for="msme_yes">Yes</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="radio" id="msme_no" name="msme" value="0" checked="checked" class="line-gray">
                            ...
                            <div class="col-4 my-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <input type="radio" id="esi_yes" name="esi" value="1" class="line-gray">
                                        <label for="esi_yes">Yes</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="radio" id="esi_no" name="esi" value="0" checked="checked" class="line-gray">
                            ...
                            <div class="col-4 my-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <input type="radio" id="epf_yes" name="epf" value="1" class="line-gray">
                                        <label for="epf_yes">Yes</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="radio" id="epf_no" name="epf" value="0" checked="checked" class="line-gray">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="line-gray" name="cheque_image" id="cheque_image" type="file" required>
                            </div>
                            <div class="col-md-6 form-group">
                        ...
                        <div class="row">
                            <div class="col-md-2 mt-3">
                                <input class="line-gray" name="submit" type="submit" id="submitBtn" value="Submit">
                            </div>
                        </div>
                    </form>
                </div>
        ...
        validation
          ...
          .onSuccess(async (event) => {
            ...
            try {
                ...
                formData.append('contact_person_name',document.getElementById('contact_person_name').value)
                ...
                if((document.getElementById('cheque_image').files).length>0){
                    formData.append('cheque_image',document.getElementById('cheque_image').files[0])
                }
                ...
                if(error?.response?.data?.errors?.scope){
                    validation.showErrors({'#scope': error?.response?.data?.errors?.scope[0]})
                }
                if(error?.response?.data?.errors?.channel_partner){
                    validation.showErrors({'#channel_partner': error?.response?.data?.errors?.channel_partner[0]})
                }
                ...
                if(error?.response?.data?.errors?.telephone){
                    validation.showErrors({'#telephone': error?.response?.data?.errors?.telephone[0]})
                }
                ...
                if(error?.response?.data?.errors?.contact_person_name){
                    validation.showErrors({'#contact_person_name': error?.response?.data?.errors?.contact_person_name[0]})
                }
                ...
                if(error?.response?.data?.errors?.pan){
                    validation.showErrors({'#pan': error?.response?.data?.errors?.pan[0]})
                }
                if(error?.response?.data?.errors?.gst){
                    validation.showErrors({'#gst': error?.response?.data?.errors?.gst[0]})
                }
                if(error?.response?.data?.errors?.sac){
                    validation.showErrors({'#sac': error?.response?.data?.errors?.sac[0]})
                }
                ...
                if(error?.response?.data?.errors?.bank_address){
                    validation.showErrors({'#bank_address': error?.response?.data?.errors?.bank_address[0]})
                }
                if(error?.response?.data?.errors?.bank_branch){
                    validation.showErrors({'#bank_branch': error?.response?.data?.errors?.bank_branch[0]})
                }
                if(error?.response?.data?.errors?.bank_account_number){
                    validation.showErrors({'#bank_account_number': error?.response?.data?.errors?.bank_account_number[0]})
                }
                if(error?.response?.data?.errors?.ifsc){
                    validation.showErrors({'#ifsc': error?.response?.data?.errors?.ifsc[0]})
                }
                if(error?.response?.data?.errors?.msme){
                    validation.showErrors({'#msme_yes': error?.response?.data?.errors?.msme[0]})
                }
                if(error?.response?.data?.errors?.msme_image){
                    validation.showErrors({'#msme_image': error?.response?.data?.errors?.msme_image[0]})
                }
                if(error?.response?.data?.errors?.esi){
                    validation.showErrors({'#esi_yes': error?.response?.data?.errors?.esi[0]})
                }
                if(error?.response?.data?.errors?.epf){
                    validation.showErrors({'#epf_yes': error?.response?.data?.errors?.epf[0]})
                }
                if(error?.response?.data?.errors?.pan_image){
                    validation.showErrors({'#pan_image': error?.response?.data?.errors?.pan_image[0]})
                }
                if(error?.response?.data?.errors?.gst_image){
                    validation.showErrors({'#gst_image': error?.response?.data?.errors?.gst_image[0]})
                }
                if(error?.response?.data?.errors?.seal_image){
                    validation.showErrors({'#seal_image': error?.response?.data?.errors?.seal_image[0]})
                }
                if(error?.response?.data?.errors?.cheque_image){
                    validation.showErrors({'#cheque_image': error?.response?.data?.errors?.cheque_image[0]})
                }
                if(error?.response?.data?.errors?.rera_image){
                    validation.showErrors({'#rera_image': error?.response?.data?.errors?.rera_image[0]})
                }
