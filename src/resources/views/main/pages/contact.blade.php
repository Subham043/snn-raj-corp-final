                ...
                <div class="col-md-8 " data-animate-effect="fadeInUp">
                    <form method="post" class="contact__form" id="contactForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <input class="line-gray" name="subject" id="subject" type="text"
                                    placeholder="Subject *" required>
                            </div>
                            <div class="col-md-12 form-group">
                                <textarea class="line-gray" name="message" id="message" cols="30" rows="4" placeholder="Message *"
                                    required></textarea>
                            </div>
                            <div class="col-md-12 mt-2">
                                <div class="col-md-12 mt-3 mb-5">
                                    ...
                                    I authorize SNN Raj Corp and its representatives to call, SMS, email, or WhatsApp
                    ...
                    <form id="otpForm" method="post">
                        <div class="mb-3">
                            <input type="text" class="form-control" id="otp" name="otp"
                                aria-describedby="otpHelp" placeholder="OTP *">
                            <div id="otpHelp" class="form-text">We have shared an OTP to your mobile via SMS.</div>
                        </div>
                        <button aria-label="Submit Otp" type="submit" id="submitOtpBtn"
                            class="btn btn-dark">Submit</button>
                        <button aria-label="Resend Otp" type="button" id="resendOtpBtn" class="btn btn-danger">Resend
                            OTP</button>
                    </form>
