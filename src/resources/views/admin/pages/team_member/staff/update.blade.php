...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('admin.includes.breadcrumb', ['page'=>'Staff', 'page_link'=>route('team_member.staff.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row" id="image-container">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('team_member.staff.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('team_member.staff.update.post', $data->id)}}', formData)
