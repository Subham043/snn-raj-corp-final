...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list users')
        @include('admin.includes.breadcrumb', ['page'=>'Legal Pages', 'page_link'=>route('legal.paginate.get'), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('legal.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                        @include('admin.includes.input', ['key'=>'page_name', 'label'=>'Page Name', 'value'=>old('page_name')])
                                    </div>
                                    <div class="col-xxl-4 col-md-4">
                                        @include('admin.includes.input', ['key'=>'slug', 'label'=>'Page Slug', 'value'=>old('slug')])
                                    </div>
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('legal.create.post')}}', formData)
