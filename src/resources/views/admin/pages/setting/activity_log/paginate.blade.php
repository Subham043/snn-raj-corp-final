...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Activity Logs', 'page_link'=>route('activity_log.paginate.get'), 'list'=>['List']])
        <!-- end page title -->
                    ...
                    <div class="card-body">
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm">
                                    @include('admin.includes.search_list', ['link'=>route('activity_log.paginate.get'), 'search'=>$search])
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="{{route('activity_log.detail.get', $item->id)}}" class="btn btn-sm btn-primary edit-item-btn">View Details</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
