...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list projects')
        @include('admin.includes.breadcrumb', ['page'=>'Accomodation', 'page_link'=>route('project.accomodation.paginate.get', $project_id), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('project.accomodation.update.post', [$project_id, $data->id])}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                            ...
                            <div class="live-preview">
                                <div class="row gy-4">
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'room', 'label'=>'Room', 'value'=>$data->room])
                                    </div>
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'area', 'label'=>'Area', 'value'=>$data->area])
                                    </div>
