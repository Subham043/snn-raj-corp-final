...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list projects')
        @include('admin.includes.breadcrumb', ['page'=>'Project', 'page_link'=>route('project.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="is_completed" name="is_completed" {{$data->is_completed==false ? '' : 'checked'}}>
