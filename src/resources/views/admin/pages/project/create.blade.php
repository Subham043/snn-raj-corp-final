                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'position', 'label'=>'Block Postion', 'value'=>old('position')])
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="use_in_home" name="use_in_home">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'srd_code', 'label'=>'Sell Do SRD', 'value'=>old('srd_code')])
                                    </div>
                                    <div class="col-xxl-6 col-md-6">
