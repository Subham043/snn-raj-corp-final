...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list projects')
        @include('admin.includes.breadcrumb', ['page'=>'Additional Content', 'page_link'=>route('project.additional_content.paginate.get', $project_id), 'list'=>['Create']])
        @endcan
        <!-- end page title -->

        <div class="row">
            @include('admin.includes.back_button', ['link'=>route('project.additional_content.paginate.get', $project_id)])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('project.additional_content.create.post', $project_id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="attatch_map" name="attatch_map">
...
.addField('#heading', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('project.additional_content.create.post', $project_id)}}', formData)
