...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list projects')
        @include('admin.includes.breadcrumb', ['page'=>'Gallery Video', 'page_link'=>route('project.gallery_video.paginate.get', $project_id), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('project.gallery_video.create.post', $project_id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'video_title', 'label'=>'Video Title', 'value'=>old('video_title')])
                                    </div>
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('project.gallery_video.create.post', $project_id)}}', formData)
