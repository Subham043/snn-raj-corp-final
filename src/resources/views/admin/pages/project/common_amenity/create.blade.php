...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list projects')
        @include('admin.includes.breadcrumb', ['page'=>'Common Amenity', 'page_link'=>route('project.common_amenity.paginate.get'), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('project.common_amenity.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('project.common_amenity.create.post')}}', formData)
