...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('site_enquiry_representative.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'paramantra_code', 'label'=>'Paramantra Code', 'value'=>old('paramantra_code')])
                                    </div>
