                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        ...
                                        <a href="{{route('campaign_plan_category_create.get', $campaign_id)}}" type="button" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Create</a>
                                    </div>
                                </div>
                                <div class="col-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="{{route('campaign_plan_category_update.get', [$item->campaign_id, $item->id])}}" class="btn btn-sm btn-success edit-item-btn">Edit</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('campaign_plan_image_list.get', [$item->campaign_id, $item->id])}}" class="btn btn-sm btn-success edit-item-btn">Plan Images</a>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" data-link="{{route('campaign_plan_category_delete.get', [$campaign_id, $item->id])}}">Delete</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
