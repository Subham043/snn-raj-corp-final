...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Projects', 'page_link'=>route('campaign_list.get'), 'list'=>['Table', 'Update']])
        <!-- end page title -->

        <div class="row">
            @include('admin.includes.back_button', ['link'=>route('campaign_table_list.get', $data->campaign_id)])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('campaign_table_update.post', [$campaign_id, $data->id])}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
