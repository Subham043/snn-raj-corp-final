...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Campaigns', 'page_link'=>route('campaign_list.get'), 'list'=>['Gallery', 'List']])
        <!-- end page title -->

        @include('admin.includes.section_title', ['section'=>'Gallery', 'link'=>route('campaign_heading.post', $campaign_id), 'key' => 'gallery_heading', 'heading_value'=>$campaign['gallery_heading']])

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Campaign Gallery</h4>
                    </div><!-- end card header -->
