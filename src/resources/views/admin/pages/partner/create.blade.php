...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list partners')
        @include('admin.includes.breadcrumb', ['page'=>'Partner', 'page_link'=>route('partner.paginate.get'), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('partner.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                            ...
                            <div class="live-preview">
                                <div class="row gy-4">
                                    <div class="col-xxl-4 col-md-4">
                                        ...
                                        <p>
                                            <code>Note: </code> Banner Size : 100 x 100
                                        </p>
                                    </div>
                                    <div class="col-xxl-4 col-md-4">
