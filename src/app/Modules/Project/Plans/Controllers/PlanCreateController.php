...
class PlanCreateController extends Controller
{
    ...
    public function get($project_id, $plan_category_id){
        $this->projectService->getById($project_id);
        return view('admin.pages.project.plan.create', compact(['project_id', 'plan_category_id']));
    }

    public function post(PlanCreateRequest $request, $project_id, $plan_category_id){
