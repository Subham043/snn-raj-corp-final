...
class EmpanelmentFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'pan_image' => 'required|image|max:5000',
            'gst_image' => 'required|image|max:5000',
            'seal_image' => 'required|image|max:5000',
            'cheque_image' => 'required|image|max:5000',
            'rera_image' => 'required|image|max:5000',
            'msme_image' => 'required_if:msme,1|image|max:5000|nullable',
