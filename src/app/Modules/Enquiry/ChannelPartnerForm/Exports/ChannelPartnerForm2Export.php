...
class ChannelPartnerForm2Export implements FromCollection,WithHeadings,WithMapping
{
    ...
    */
    ...
    {
        return ChannelPartnerForm::where('channel_partner_phone', auth()->user()->phone)->get();
    }
}